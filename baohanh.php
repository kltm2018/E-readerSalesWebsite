...
<body>
    ...
    <br><br>
    <h2 style="text-align: center;" style="font-family: 'Times New Roman', Times, serif';"> Bảo hành 01 năm <br>
        Đổi mới trong vòng 1 tuần đầu nếu
        có lỗi của nhà sản xuất.<br>
        Hỗ trợ phần mềm trọn đời.</h2>
    <br><br>
